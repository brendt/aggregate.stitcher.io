...
<x-tag
    :url="action(\App\Http\Controllers\Posts\PostCommentsController::class, $post->uuid)"
    :class="$user && $user->hasUnreadComments($post) ? 'has-new-comments' : '' "
>
